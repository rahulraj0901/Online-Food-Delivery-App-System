...
import com.onlinefood.dto.OrderResponseDto;
import com.onlinefood.dto.UpdateDeliveryStatusRequest;
import com.onlinefood.resource.OrderResource;
...
public class OrderController {
	...
	public ResponseEntity<CommonApiResponse> placeOrder(@RequestParam("userId") int userId) {
		return orderResource.orderFoodsFromCart(userId);
	}
	...
	@Operation(summary = "Api to fetch restaurant orders")
	public ResponseEntity<OrderResponseDto> fetchRestaurantOrders(@RequestParam("restaurantId") int restaurantId) {
		return orderResource.fetchRestaurantOrders(restaurantId);
	}
