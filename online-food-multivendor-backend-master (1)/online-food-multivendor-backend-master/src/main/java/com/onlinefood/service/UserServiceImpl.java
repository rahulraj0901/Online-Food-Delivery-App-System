...
public class UserServiceImpl implements UserService {
	...
	@Override
	public List<User> getUserByRestaurantAndRoleAndStatusIn(User seller, String role, List<String> status) {
		return this.userDao.findByRestaurantAndRoleAndStatusIn(seller, role, status);
	}
